      ...
      >
        ...
        >
          <div>
            ...
            <p className='py-5'>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam veritatis itaque eos corporis minima velit doloremque modi nesciunt doloribus.
            </p>
          </div>
        </motion.div>
        ...
        <div className='mt-10 justify-between gap-8 md:flex'>
          ...
          >
            <div className='mb-5 md:before:content-evolvetext w-full before:absolute before:-bottom-20 before:-right-10 before:z-[-1]'>
