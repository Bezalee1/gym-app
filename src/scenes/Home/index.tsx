...
const Home = ({setSelectedPage}: Props) => {
  ...
  return (
    <section id="home" className="gap-16 md:mt-20 bg-gray-20 py-10 md:h-full md:pb-0">
        <motion.div 
            className="mx-auto gap-x-8 w-5/6 items-center justify-center md:flex md:h-5/6"
